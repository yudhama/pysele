...
def test_make_appointment_from_csv():
    with open('cobaTest/files/credentials.csv', newline='') as csvfile:
        ...
        for row in reader:
            ...
            print(f"User: {row['username']} - Details: {details}")
            menu_page.logout()
            driver.quit()

if __name__ == "__main__":
    test_make_appointment_from_csv()